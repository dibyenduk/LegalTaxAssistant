...
| Requirement | Details |
|-------------|---------|
| Azure AD Tenant | An Azure Active Directory (Entra ID) tenant |
...
| **Microsoft 365 Copilot** | ❌ Not required | The application uses Azure AI Foundry agents, not Microsoft 365 Copilot. No Copilot license is needed |
...
### Azure Resources Provisioned by This Project

These are created automatically by `azd provision`:

| Resource | Provider | Purpose |
|----------|----------|---------|
| Cosmos DB Account | `Microsoft.DocumentDB` | Stores requests, questions, answers, user roles |
...
|------|---------|---------|
| [Azure Developer CLI (azd)](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd) | Latest | Deployment orchestration (`azd up`, `azd deploy`) |
| [Azure CLI (az)](https://learn.microsoft.com/cli/azure/install-azure-cli) | Latest | Resource provider registration, ACR login, RBAC |
| [Python](https://www.python.org/downloads/) | 3.11+ | Agent provisioning scripts, local development |
| [Docker Desktop](https://www.docker.com/products/docker-desktop/) | Latest | Local testing and container builds |
...
Installed automatically during deployment, but listed here for reference:
